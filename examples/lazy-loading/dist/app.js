...
// examples/lazy-loading/src/components/AppShell.component.ts
...
// examples/lazy-loading/src/components/NavBar.component.ts
var _NavBar = class _NavBar extends Are {
  template(node) {
    node.setContent(`
            <aside class="nav">
                <div class="nav-brand">ARE \xB7 Lazy Loading</div>
                <nav class="nav-links">
...
// examples/lazy-loading/src/components/HomePage.component.ts
var _HomePage = class _HomePage extends Are {
  template(node) {
    node.setContent(`
            <section class="page">
                <span class="eyebrow eyebrow-eager">Eager \xB7 bundled</span>
...
__decorateClass([
  Are.Template,
  __decorateParam(0, Yt(te))
], _HomePage.prototype, "template", 1);
__decorateClass([
  Are.Styles,
  __decorateParam(0, Yt(te))
], _HomePage.prototype, "styles", 1);
var HomePage = _HomePage;

// examples/lazy-loading/src/runtime/ComponentManifest.fragment.ts
var ComponentManifest = class extends H {
  constructor(data) {
...
__name(ComponentManifest, "ComponentManifest");
ComponentManifest = __decorateClass([
  R2.Define({
...
// examples/lazy-loading/src/components/LazyOutlet.component.ts
var _LazyOutlet = class _LazyOutlet extends Are {
  template(node, manifest) {
  ...
  async onSignal(node, logger, manifest, signalsContext) {
    const route = document.location.pathname || "/";
    const entry = manifest.match(route) ?? manifest.match("/");
    if (!entry) {
...
__name(_LazyOutlet, "LazyOutlet");
__decorateClass([
  Are.Template,
  __decorateParam(0, Yt(te)),
  __decorateParam(1, Yt(ComponentManifest))
], _LazyOutlet.prototype, "template", 1);
__decorateClass([
  Are.Signal,
  __decorateParam(0, Yt(te)),
  __decorateParam(1, Yt(A_Logger)),
  __decorateParam(2, Yt(ComponentManifest)),
  __decorateParam(3, Yt(AreSignalsContext))
], _LazyOutlet.prototype, "onSignal", 1);
var LazyOutlet = _LazyOutlet;

// examples/lazy-loading/src/runtime/LazyComponentResolver.fragment.ts
var LazyComponentResolver = class extends AreComponentResolver {
  constructor(data) {
...
__name(LazyComponentResolver, "LazyComponentResolver");
LazyComponentResolver = __decorateClass([
  R2.Define({
    namespace: "a-are-html-example",
...
// examples/lazy-loading/src/concept.ts
(async () => {
  try {
    const entries = await fetch("/api/components").then((res) => res.json()).catch(() => []);
